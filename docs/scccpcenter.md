...
1.首先点击此处[下载最新ClientGuard反作弊软件(1.7.0)](https://github.com/EpsilonNetWorkGroup/SCCCPServerWikiPublicFile/raw/clientguard/ClientGuard-1.7.0-obf.jar), 下载完成后, 将其作为Fabric模组放入mods文件夹(仅支持Windows平台)  
